...
The *Configuration* tab it is the entry point to obtain information about the resources of the Virtual Machine. It includes five subtabs:
...
You may continue to the next lab, _Virtual Machine Customization_, where you will customize the VM during creation, and you will be able to manage the VM.
